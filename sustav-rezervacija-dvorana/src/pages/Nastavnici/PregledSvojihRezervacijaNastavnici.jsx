...
export default function PregledSvojihRezervacijaNastavnici() {
    ...
    const [programs, setPrograms] = useState([
        { id: 1, naziv_kolegija: 'Programiranje', dvorana:"Dvorana 1", datum: "05.04.2024", pocetak: "08:00", kraj: "11:45", razlog: 'Predavanje'},
        { id: 2, naziv_kolegija: 'Elementi telematike', dvorana:"Dvorana 2", datum: "15.04.2024", pocetak: "10:00", kraj: "16:45", razlog: 'Predavanje'},
        { id: 3, naziv_kolegija: 'Baze podataka', dvorana:"Dvorana 3", datum: "25.04.2024", pocetak: "16:30", kraj: "20:45", razlog: 'Ispit'},
    ]);
    ...
    const uredi_stisnuto = () => {
        navigate("/azuriranjeSvojihRezervacija");
    }
